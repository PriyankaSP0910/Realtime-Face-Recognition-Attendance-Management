...
class Face_Recognition_System:
    def __init__(self,root):    #calling constructor #root is root window
        ...
        img=img.resize((1530,85),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        #bg image
        bg=Image.open(r"C:\Users\91900\Desktop\face_recognition system\college_images\middle.png")
        bg=bg.resize((1530,750),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        logo=logo.resize((80,80),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        user=user.resize((55,55),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        exit=exit.resize((55,55),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        #button student
        bs=Image.open(r"C:\Users\91900\Desktop\face_recognition system\college_images\stud.jpeg")
        bs=bs.resize((220,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        self.photoimg3=ImageTk.PhotoImage(bs)          #img stored in a variable self.photoimg 
        b1=Button(bglbl,image=self.photoimg3,cursor="hand2")
        ...
        btd=btd.resize((220,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        bp=bp.resize((230,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        #button attendence
        ba=Image.open(r"C:\Users\91900\Desktop\face_recognition system\college_images\attend.jpeg")
        ba=ba.resize((230,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        self.photoimg6=ImageTk.PhotoImage(ba)          #img stored in a variable self.photoimg 
        ba=Button(bglbl,image=self.photoimg6,cursor="hand2")
        ...
        bfg=bfg.resize((230,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
        ...
        #button train data
        be=Image.open(r"C:\Users\91900\Desktop\face_recognition system\college_images\exit.jpeg")
        be=be.resize((230,400),Image.ANTIALIAS)    #we resized width and height of image to 500 and 130, ANTIALIAS ued to return resized images
